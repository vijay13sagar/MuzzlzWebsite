...
import './Home.css';
import { InstaHead, Headtag, Hometext, HomeFoot, Bookbtn } from '../Components/styles';
        ...
        <div className='cont' id='home'>
            ...
            <div id="vidtop-content">
                <Headtag>
                    ...
                    <Link  to='contact' smooth={true} duration={1000}><Bookbtn>Book appointment</Bookbtn></Link>
